...
///
/// Exposes task creation, status polling, and log retrieval so the UI can show
/// users exactly what happened during long-running operations — analogous to
/// Coolify's deployment log streaming.
