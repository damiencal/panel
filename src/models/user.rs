...
pub struct User {
    ...
    /// Omitted from API responses — internal to the server. (SEC-35-05)
    #[serde(skip)]
    ...
    /// Set whenever the user changes their password. JWTs with iat < this
    /// timestamp are treated as revoked (SESS-01 mitigation).
